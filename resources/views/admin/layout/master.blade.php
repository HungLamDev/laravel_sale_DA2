                        ...
                        <ul class="vertical-nav-menu">
                            ...
                            <li class="mm-active">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a
                                            href="./admin/product"class="{{ request()->segment(2) == 'product' ? 'mm-active' : '' }}">
                                            <i class="metismenu-icon"></i>Product
                                        </a>
                                    </li>
                                    <li>
                                        <a
                                            href="./admin/category"class="{{ request()->segment(2) == 'category' ? 'mm-active' : '' }}">
                                            <i class="metismenu-icon"></i>Category
                                        </a>
                                    </li>
                                    <li>
                                        <a
                                            href="./admin/brand"class="{{ request()->segment(2) == 'brand' ? 'mm-active' : '' }}">
                                    ...
                                    <div class="vertical-timeline-element-content bounce-in">
                                        <h4 class="timeline-title">Something not important
                                            <div class="avatar-wrapper mt-2 avatar-wrapper-overlap">
                                                ...
                                                <div class="avatar-icon-wrapper avatar-icon-sm">
                                                    <div class="avatar-icon">
                                                        <img src="./dashboard/assets/images/avatars/6.jpg"
                                                            alt="">
                                                    </div>
                                                </div>
                                                <div class="avatar-icon-wrapper avatar-icon-sm">
