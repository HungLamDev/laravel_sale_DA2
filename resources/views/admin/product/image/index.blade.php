                ...
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        ...
                        <div class="position-relative row form-group">
                            <label for="name" class="col-md-3 text-md-right col-form-label">Sản phẩm Tên</label>
                                ...
                                <ul class="text-nowrap" id="images">
                                    @foreach ($productImages as $productImage)
                                        <li class="float-left d-inline-block mr-2 mb-2"
                                            ...
                                            <form action="./admin/product/{{ $product->id }}/image/{{ $productImage->id }}"
                                                method="post">
                                                @csrf @method('DELETE')
                                                <button type="submit"
                                            ...
                                            <div style="width: 100%; height: 220px; overflow: hidden;">
                                                <img src="./front/img/products/{{ $productImage->path }}" alt="Image">
                                            </div>
                                        </li>
                                    @endforeach
                                    <li class="float-left d-inline-block mr-2 mb-2" style="width: 32%;">
                                        <form method="post" action="admin/product/{{ $product->id }}/image"
