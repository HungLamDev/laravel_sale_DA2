                    ...
                    <div class="card-body">
                        <form method="post" action="admin/user" enctype="multipart/form-data">
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input required name="Tên" id="name" placeholder="Name" type="text"
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input name="password_confirmation" id="password_confirmation"
                                        placeholder="Xác nhận Mật khẩu" type="password" class="form-control" value="">
                                </div>
                            </div>
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input name="company_name" id="company_name" placeholder=" Tên công ty" type="text"
                                        class="form-control" value="">
                                </div>
                            </div>
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input name="street_address" id="street_address" placeholder="Địa chỉ" type="text"
                                        class="form-control" value="">
                                </div>
                            </div>
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input name="postcode_zip" id="postcode_zip" placeholder="Mã bưu điện"
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input name="town_city" id="town_city" placeholder="Thành phố" type="text"
                                        class="form-control" value="">
                                </div>
                            </div>
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input required name="phone" id="phone" placeholder="số điện thoại"
                                        type="tel" class="form-control" value="">
                                </div>
                            </div>

                            <div class="position-relative row form-group">
                                <label for="level" class="col-md-3 text-md-right col-form-label">Điện thoại</label>
                                <div class="col-md-9 col-xl-8">
