                        ...
                        <tr>
                            ...
                            @if ($order->payment_type == 'pay_later')
                                <td class="pl-3" style=" padding-left:15px;">
                                    <span class="d-inline"
                                        ...
                                        Bạn sẽ thanh toán khi giao hàng. Chúng tôi vừa bàn giao đơn đặt hàng của bạn cho
                                        một đối tác vận chuyển .
                                    </span>
                                </td>
                            @endif
                            ...
                            @if ($order->payment_type == 'online_payment')
                                <td class="pl-3" style=" padding-left:15px;">
                                    <span class="d-inline"
                                        style="color:#424853; font-family:trebuchet,sans-serif; font-size:16px; font-weight:normal; line-height:22px;">
                                        Đơn đặt hàng của bạn đã được thanh toán trực tuyến. Chúng tôi vừa bàn giao đơn
                                        đặt hàng của bạn cho một đối tác vận chuyển
                                    </span>
                                </td>
                                ...
                                <thead>
                                    <tr>
                                        <th style="padding: 5px 0;">
                                            SẢN PHẨM</th>
                                        <th style="padding: 5px 20px 5px 0; text-align: right;">TẤT CẢ</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach ($order->orderDetails as $orderDetail)
                                        <tr>
                                            ...
                                            <td
                                                ...
                                                {{ number_format(floatval($orderDetail->total), 0, ',', '.') }}₫
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            ...
                            <div class="col-12 p-0">
                                ...
                                <table class="mt-2 w-100"
                                    ...
                                    <tr style="font-size: 18px;">
                                        <td><b>TẤT CẢ</b></td>
                                        <td class="pr-3 text-right" style="text-align: right; padding-right: 20px;">
                                            <b>{{ number_format(floatval($total), 0, ',', '.') }}₫ </b>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                ...
                <div class="row mt-2 mb-4" style="margin-top: 15px; margin-bottom: 25px;">
                    <div class="container-fluid">
                        ...
                        <div class="row pl-3 py-2" style="background-color: #fff; padding: 10px 20px;">
                            <p>Bạn có thể kiểm tra hình thức bên ngoài của sản phẩm (thương hiệu, mẫu mã, màu sắc, số
                                lượng,...) trước khi thanh toán và có thể từ chối nhận hàng nếu không hài lòng. Vui lòng
                                không kích hoạt thiết bị điện-điện tử hoặc dùng thử sản phẩm.</p>

                            <p>Nếu sản phẩm có dấu hiệu hư hỏng/vỡ hoặc không khớp với thông tin trên website, vui lòng
                                liên hệ cửa hàng trong vòng 48h kể từ thời điểm nhận hàng sự giúp đỡ.</p>

                            <p>Quý khách vui lòng giữ lại hóa đơn, hộp sản phẩm và phiếu bảo hành (nếu có) để đổi trả
                                hoặc bảo hành Khi Cần thiết.</p>

                            <p>Bạn có thể tham khảo trang Trung tâm trợ giúp hoặc liên hệ với cửa hàng bằng cách để lại
                                tin nhắn tại Trang liên hệ hoặc gửi thư tại đây. Hotline 0772190842 (8:00 - 9:00 cả thứ
                                bảy và chủ nhật).
                            </p>
